...
import com.example.chap6top5.*
import com.example.chap6top5.databinding.ActivityProfileBinding
    ...
    fun logoutGoogle(){
        ...
        binding.logoutGoogle.setOnClickListener {
            mGoogleSignInClient.signOut().addOnCompleteListener {
                ...
                Toast.makeText(this,"berhasil logout google", Toast.LENGTH_SHORT).show()
